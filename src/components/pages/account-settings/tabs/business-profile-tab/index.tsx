...
import { Check, Link2, Store, Trash2 } from 'lucide-react';
      ...
      <FormProvider {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          <SettingsSection
            icon={Store}
            title="Basic Details"
            description="Manage your gym's basic information and contact details"
          ...
          <SettingsSection
            icon={Link2}
            title="Social Links"
            description="Add links to your gym's public social profiles"
