...
const ValueCard = ({ isRevenue, value }: ValueCardProps) => {
  return (
    <div className="p-3 rounded-xl flex flex-col gap-2 bg-card-bg/90 max-w-[173px] w-full z-10">
      ...
      <span className="text-[24px] leading-normal">
...
bg-gradient-to-l from-[#90A8ED]/35 to-[#11141C] relative"
    >
      ...
      <div className="flex flex-col">
        ...
        <span className="mt-1 text-[64px] leading-normal">
          {formatCurrency('110000')}
        </span>
        <div className="flex items-center gap-3 mt-4">
          <span
            className={`flex items-center gap-1 px-2 py-1 rounded-[34px] text-[15px] leading-normal border ${higherThanLastMonth ? 'bg-neutral-green-500/20  border-neutral-green-500' : 'bg-alert-red-500/20  border-alert-red-500'}`}
          >
            {higherThanLastMonth ? (
              <ArrowUp size={14} className="text-neutral-green-500" />
            ) : (
