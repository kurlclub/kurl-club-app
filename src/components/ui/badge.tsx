  ...
  'inline-flex items-center rounded-md border p-1.5 pr-2 text-sm leading-normal text-white font-normal transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 cursor-default text-nowrap',
  {
    variants: {
      variant: {
        ...
        secondary:
          'border-transparent bg-primary-blue-400/50 text-secondary-foreground hover:bg-secondary/80',
        warning:
          'border-secondary-yellow-500 bg-primary-blue-400 text-white hover:bg-secondary-yellow-500/20',
        destructive:
